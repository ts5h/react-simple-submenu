...
export default class Submenu extends Component {
  ...
  render() {
    return (
      <ul ref={this.setMenuMain} className={Styles.main}>
        <li onMouseOver={() => this.showMenuSub({ menu1: true })} onMouseOut={() => this.showMenuSub({ menu1: false })}>
          Menu 1
        ...
        <li onMouseOver={() => this.showMenuSub({ menu2: true })} onMouseOut={() => this.showMenuSub({ menu2: false })}>
          Menu 2
